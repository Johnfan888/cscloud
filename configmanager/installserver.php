...
<html xmlns="http://www.w3.org/1999/xhtml">
 <head>
  ...
  <script language="javascript" type="text/javascript"> 
	function installManageserver()
	{
	window.location.href="./install_manager.php";

	} 
	function installFileserver()
	{
	window.location.href="./install_fileserver.php";
					...
					<div class="page-list" id="js_data_list_outer">
						<div style="min-height:100%;_height:100%;cursor:default; background:#fff;" id="js_data_list">
							<table border=0 cellspacing=1 align=center class=Navi>
							  <tr>
								<th colspan="2">安装服务器</th>
								<form><tr><td><input type="button" onClick="installManageserver()" value="安装ManageServer"></td><td><input type="button" onClick="installFileserver()" value="安装FileServer"></td></tr></form>
							  </tr>
							</table>
						</div>
					</div>
