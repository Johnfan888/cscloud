				...
				{  
					  ...
					  //如果该菜单项目是目录，则添加JavaScript   onClick语句             
						...
						{             
							...
							echo " <br><a href='delconfirm.php?dir=$menu11[locationpath]&id=$menu[id]&name=$menu[name]&serverip=$menu11[serverip]'>[删除]</a>";						
				 ...
				 //----------------------------------------------------------------
					...
					{//说明是第一次访问该页
						 echo   "<tr><td align='center'><img	src='file.gif'   border='0'></td>
						  <td>".$menu['name']."<a href='advancedsearch.php?version_flag=1&name=".$menu['name']."&pid=".$menu['parent_id']."&select1=".$select1."&select2=".$select2."&selectcondition1=".$selectcondition1."&selectcondition2=".$selectcondition2."&keywords=".$keywords."'>详细信息</a></td>";  
					}
					else
					{//说明是通过点击详细信息而访问的该页
						 ...
						 {//关闭
						  echo   "<tr><td align='center'><img	src='file.gif'   border='0'></td>
						  <td>".$menu['name']."<a href='advancedsearch.php?version_flag=0&name=".$menu['name']."&pid=".$menu['parent_id']."&select1=".$select1."&select2=".$select2."&selectcondition1=".$selectcondition1."&selectcondition2=".$selectcondition2."&keywords=".$keywords."'>详细信息</a></td>"; 
						 }else{//其他的
						  echo   "<tr><td align='center'><img	src='file.gif'   border='0'></td>
						  <td>".$menu['name']."<a href='advancedsearch.php?version_flag=1&name=".$menu['name']."&pid=".$menu['parent_id']."&select1=".$select1."&select2=".$select2."&selectcondition1=".$selectcondition1."&selectcondition2=".$selectcondition2."&keywords=".$keywords."'>详细信息</a></td>"; 
						}
