<?php /* Smarty version 2.6.14, created on 2012-04-12 07:55:42
...
<div class="main">
    <div class="reg-title"><strong>快速注册，立即拥有15G超大网络硬盘！</strong><span>1.填写注册信息 <em>»  2.验证注册邮箱  »  3.完成注册</em></span></div>
        <div class="reg-form">
        <ul class="reg-tab">
        ...
        <form vail="1" id="signForm" action="" method="post" autocomplete="off">
            <dl>
                <dt>Email地址：</dt>
                <dd>
                    <input type="hidden" name="reg[invite]" value="">
                    <input type="hidden" name="reg[goto]" value="https://passport.115.com/?ct=register_mobile" style="display: inline-block; ">
                    <input type="text" id="reg_email" name="reg[email]" class="text" maxlength="50" errortype="email" errmsgtype="2" errmsg="请输入正确的邮箱地址" value="" err="1">
                ...
                <dd class="form-text"><a href="#" target="_blank">《ISTL 网络服务使用协议》</a></dd>
            </dl>
        </form>
    </div>
<div class="login-link">
    ...
    <dl>
        <dt>或者使用合作网站帐号登录：</dt>
        <dd><i class="acc-qq"></i><a href="https://passport.115.com/?ct=open_login&amp;t=qq">腾讯QQ</a></dd>
        <dd><i class="acc-sina"></i><a href="https://passport.115.com/?ct=open_login&amp;t=sina">新浪微博</a></dd>
        <dd><i class="acc-tencent"></i><a href="https://passport.115.com/?ct=open_login&amp;t=tqq">腾讯微博</a></dd>
        <dd><i class="acc-renren"></i><a href="https://passport.115.com/?ct=open_login&amp;t=renren">人人网</a></dd>
        <dd><i class="acc-neteasy"></i><a href="https://passport.115.com/?ct=open_login&amp;t=t163">网易微博</a></dd>
        <dd><i class="acc-douban"></i><a href="https://passport.115.com/?ct=open_login&amp;t=douban">豆瓣网</a></dd>
        <dd><i class="acc-baidu"></i><a href="https://passport.115.com/?ct=open_login&amp;t=baidu">百度</a></dd>
        <dd><i class="acc-surfing"></i><a href="https://passport.115.com/?ct=open_login&amp;t=surfing">天翼</a></dd>
    </dl>
</div></div>
...
<div class="footer">
    <div class="con">
        <div class="copy-right">© 2012 ISTL</div>
        <dl>
            <dt>ISTL网盘</dt>
        </dl>
        <dl>
