...
<div id="fdbgdiv" >
	...
	<div id="foundquestiondiv">密保问题： <input id="fdquestion" type="text" style=" width: 100px; height:15px; border:1px #000000 solid;" /></div>
  <div id="foundanswerdiv">密保答案： <input id="fdanswer" type="text" style=" width: 100px; height:15px; border:1px #000000 solid;" /></div>
