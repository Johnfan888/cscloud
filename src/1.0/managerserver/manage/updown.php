...
<tr><td>        
	...
	<table width='30%'border="1" cellspacing="0" cellpadding="0" align="center" class=Navi>
		<tr><td>
		<a href="up_downloadmanager.php?parent_id=0&user=<?php echo $_COOKIE['admin']['username'];?>"><strong>备份文件</strong></a></td></tr>
		<tr><td>
		<form action="createnewdir.php?parent_id=0" method="post">
		<p><strong>新建目录</strong></p>
		输入目录名：<input name="dirname" type="text">
		<p><input name="" type="submit"  value="创建">
...
<p class="STYLE2"> 最近操作的文件列表  <a href="updown_seeall.php"><strong>转到根目录</strong></a></p>
<?php  
...
/*	$sql="select * from tb_file_cache";
	...
	echo "tb_file_cache共有文件数：" .$numall;*/
				 ...
				 //----------------------------------------------------------------
					...
					{//说明是第一次访问该页
						 echo   "<tr><td align='center'><img	src='file.gif'   border='0'></td>
						  <td>".$menu['name']."<a href='updown.php?version_flag=1&name=".$menu['name']."&pid=".$menu['parent_id']."'>详细信息</a></td>";  
					}
					else
					{//说明是通过点击详细信息而访问的该页
						 ...
						 {//关闭
						  echo   "<tr><td align='center'><img	src='file.gif'   border='0'></td>
						  <td>".$menu['name']."<a href='updown.php?version_flag=0&name=".$menu['name']."&pid=".$menu['parent_id']."'>详细信息</a></td>";  
						 }else{//其他的
						  echo   "<tr><td align='center'><img	src='file.gif'   border='0'></td>
						  <td>".$menu['name']."<a href='updown.php?version_flag=1&name=".$menu['name']."&pid=".$menu['parent_id']."'>详细信息</a></td>";  
						}
